...
namespace GameStateManagement
{
    ...
    private const int SelectedEntry = 0;
    readonly string _menuTitle;
        ...
        {
            Keys[] keys = new [] { Keys.D1, Keys.D2, Keys.D3, Keys.D4, Keys.D5, Keys.D6, Keys.D7, Keys.D8, Keys.D9 };
            ...
            var countOfOptions = Math.Min(keys.Length, _menuEntries.Count);
            for (int i = 0; i < countOfOptions; i++)
                {
                if (input.IsNewKeyPress(keys[i], null, out _))
                    {
